...
const TableStyled = styled.div<{ playing: boolean; results: boolean }>`
  display: grid;
...
function Table() {
  ...
  function launchHousePick(): Promise<string> {
  ...
  function playWithIA(pick: string, housePick: string): string {
    if (housePick === pick) {
      return "draw";
    }
    if (pick === "paper") {
